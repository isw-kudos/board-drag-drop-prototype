      ...
      "childNodes": [
        {
          ...
          "childNodes": [
            ...
            {"id":"e","name": "Design new work for reporting module","commonType":"entry"},
            {"id":"f","name": "Design new UI for reporting module","commonType":"todo","completed":1},
            {"id":"g","name": "Design new work for reporting module","commonType":"todo","completed":0},
            {"id":"h","name": "Design new UI for reporting module","commonType":"entry"},
            {"id":"i","name": "Design new stub for reporting module","commonType":"todo","completed":0},
            {"id":"j","name": "Design factory for reporting module","commonType":"todo","completed":1},
            {"id":"k","name": "Resolve framework","commonType":"entry"}
          ]
        },
        {
          "id":"2",
